...
if($conn)
{
	...
	if($is_db_found)
	{
		$query = "select sm.mail_id from student_mail as sm where sm.student_reg='".$reg_no."' and sm.inbox='1' and sm.trash='0'";
...
//					echo "subject = ",$mail_data['subject'];
					...
					/*		echo "fname ",$sender_fname;
							...
							echo true;*/
							$response = "<div class='email' id=inbox_".$id." onClick='fun(this.id)'> <div> <img class='email_pic' src='profile_pics/".$sender_pic."'> </div>
