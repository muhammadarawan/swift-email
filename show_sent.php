...
if($conn)
{
	...
	if($is_db_found)
	{
		$query = "select sm.mail_id from student_mail as sm where sm.student_reg='".$reg_no."' and sm.sent='1' and sm.trash='0'";
		...
		//	echo true;
			...
			//	echo true;
				...
				//	echo true;
					...
					$query = "select sm.student_reg from student_mail as sm where sm.mail_id='".$id."' and sm.inbox='1'";
					$sender = mysql_query($query);
					if($sender)
					{
						$counter = 0;
						while($sender_info = mysql_fetch_assoc($sender))
						{
						...
						/*		echo "fname ",$sender_fname;
								...
								echo true;*/
								$response = "<div class='email' id=sent".$counter."_".$id." onClick='fun(this.id)'> <div> <img class='email_pic' src='profile_pics/".$sender_pic."'> </div>
										<div> <h5 class='sender_name' >".$sender_fname." ".$sender_lname. "</h5><h5 class='sender_name' >".$sender_reg_no."</h5>
